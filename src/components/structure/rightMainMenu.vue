    ...
    <q-list>
      ...
      <div class="mainMenuWrapper">
        <ul>
          ...
          <li class="mainMenuLi">
            <!-- services route -->
            <router-link :to="'/' +locale + '/' + 'services'">
          ...
          <li class="mainMenuLi">
            ...
            <router-link :to="'/' +locale + '/' + 'userManagement'">
          ...
          <li class="mainMenuLi">
            <!-- contract route -->
            <router-link :to="'/' +locale + '/' + 'contracts'">
