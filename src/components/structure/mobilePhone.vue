  ...
  <div>
    ...
    >
      ...
      <p v-if="errors" class="error">
        <span v-if="!$v.number.minLength">*{{$t('Fieldmusthaveatleast11characters')}}.</span>
      </p>
    </q-input>
    <button @click="formatter">save</button>
  </div>
</template>


<script>
import '../../statics/countries.json';
  ...
  methods: {
    formatter() {
      ...
      if (this.errors === false && this.empty === false) {
        ...
        const number = phoneUtil.parseAndKeepRawInput(this.number, this.model);
        console.log(number);
        ...
        // const type = phoneUtil.getNumberType(completeNum);
        // console.log(type);
